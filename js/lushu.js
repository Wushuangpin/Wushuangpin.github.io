...
(function() {
    ...
    c.prototype.start = function() {
        ...
        if (f.i && f.i < e - 1) { if (!f._fromPause) { return } else { if (!f._fromStop) { f._moveNext(++f.i) } } } else {
            ...
            f._timeoutFlag = setTimeout(function() {
                f._addInfoWin();
                if (f._opts.defaultContent == "") { f.hideInfoWindow() }
                f._moveNext(f.i)
            }, 400)
        }
    ...
    a.object.extend(c.prototype, {
        ...
        _move: function(n, j, m) {
            ...
            i._intervalFlag = setInterval(function() {
                if (h >= g) {
                    ...
                    i._map.setCenter(q);
                    if (h == 1) { var p = null; if (i.i - 1 >= 0) { p = i._path[i.i - 1] } if (i._opts.enableRotation == true) { i.setRotation(p, n, j) } if (i._opts.autoView) { if (!i._map.getBounds().containsPoint(q)) { i._map.setCenter(q) } } }
        ...
        _clearTimeout: function() {
            for (var e in this._setTimeoutQuene) { clearTimeout(this._setTimeoutQuene[e]) }
        ...
        _troughPointIndex: function(f) {
            var h = this._opts.landmarkPois,
                j;
            for (var g = 0, e = h.length; g < e; g++) { if (!h[g].bShow) { j = this._map.getDistance(new BMap.Point(h[g].lng, h[g].lat), f); if (j < 10) { h[g].bShow = true; return g } } }
            return -1
        }
    });
